...
namespace BotFramework
{
    ...
    public class AdaptiveCard : Card
    {
        ...
        public List<AdaptiveCards.CardElement> Body { get => Card.Body; set => Card.Body = value; }
        ...
        /// </summary>
        [JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
        public List<AdaptiveCards.ActionBase> Actions { get => Card.Actions; set => Card.Actions = value; }
        ...
        /// </summary>
        [JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
        public string BackgroundImage { get => Card.BackgroundImage; set => Card.BackgroundImage = value; }

        /// <summary>
        ///     version of schema that this card was authored
        /// </summary>
        [JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
        public string Version { get => Card.Version; set => Card.Version = value; }
        ...
        /// </summary>
        [JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
        public string MinVersion { get => Card.MinVersion; set => Card.MinVersion = value; }
